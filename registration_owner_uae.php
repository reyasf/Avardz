<?php
    ...
    class registration_owner_uae extends Controller
    {
        public $wrapper    = 'page';
        ...
        function main()
        {
                    ...
                    case FORM_OK :
                        ...
                        else
                        {
                            if ($error == '')
                            {
                                ...
                                $owner->pass                = '';
                                $owner->parent_id           = 0;
                                $owner->group_id            = Application::GROUP_UAE_SHOP_OWNER;
            ...
            $this->view('BODY', $tpl, Array('error' => $error, 'display' => $display,'country_selected'=>$country_selected,"lang" => $lang,"first" => $first, 'second' => $second,'captcha' => $captcha) );
